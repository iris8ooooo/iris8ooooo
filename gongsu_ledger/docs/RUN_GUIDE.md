...
- [ ] 달력에서 **공휴일**(예: 10월 3일 개천절, 10월 9일 한글날) 칸에 빨간 테두리와 이름이 보이고 숫자가 빨간색이다. 달력 위 오른쪽에 "개천절 3 · 대체휴일 5 · 한글날 9" 요약, 큰 숫자 아래에 "공휴일 n일"이 빨갛게 보인다. 그 날짜를 탭하면 시트 제목에 "· 개천절"처럼 공휴일 이름이 붙는다
